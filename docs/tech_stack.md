...
| 方式 | 実現方法 |
|------|----------|
| マジックリンク | Better Auth `magicLink` プラグイン + Resend でメール送信 |
...
- **パス規約**: `receipts/{user_id}/{record_id|settlement_id}/{filename}`
